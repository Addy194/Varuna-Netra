...
const DEMO = [
  { role: "analyst", email: "analyst@varunanetra.demo", scope: "ingest · correlate · review" },
  { role: "supervisor", email: "supervisor@varunanetra.demo", scope: "+ acknowledge alerts · override cases" },
];
