...
ANALYST = ("analyst@varunanetra.demo", os.environ["TEST_ANALYST_PASSWORD"])
SUPERVISOR = ("supervisor@varunanetra.demo", os.environ["TEST_SUPERVISOR_PASSWORD"])
...
class TestNotifications:
    ...
    def test_alert_has_notification_not_configured(self, sup_h, admin_h):
        ...
        # Should include admin/supervisor emails (unless muted)
        assert "supervisor@varunanetra.demo" in n["recipients"] or "shawpriyanshu950@gmail.com" in n["recipients"]
        assert n["sent"] == 0
