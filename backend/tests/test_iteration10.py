...
ANALYST = {"email": "analyst@varunanetra.demo", "password": os.environ["TEST_ANALYST_PASSWORD"]}
SUPERVISOR = {"email": "supervisor@varunanetra.demo", "password": os.environ["TEST_SUPERVISOR_PASSWORD"]}
